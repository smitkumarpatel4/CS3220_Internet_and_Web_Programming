...
public class Admin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<a href=\"InspireMe\" class=\"btn btn-primary\"> Inspire Me </a>");
		out.println("</div>");

		// generate a form for the add new quote

		out.println(
				"<Form action= \"Admin\" method= \"post\" class=\"form-inline\" class=\"navbar class=\"navbar-brand\">");
		...
		for (AdminEntry quote : quotes) {
			...
			out.println("<td>");
			out.println(" <a href=\"DeleteQuote?id=" + quote.getId() + "\" class=\"btn btn-primary\"> Delete </a>");
			out.println("</td>");
