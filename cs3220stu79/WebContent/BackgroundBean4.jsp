...
<html>
    ...
    <body>
            ...
            <form>
            <input type="text" name="red" placeholder="enter the red channel value"><br />
            <input type="text" name="green" placeholder="enter the green channel value"><br />
            <input type="text" name="blue" placeholder="enter the blue channel value"><br />
